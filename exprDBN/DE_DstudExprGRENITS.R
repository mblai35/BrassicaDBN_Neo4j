# DE_DstudExprGRENITS.R
# R version 3.3.1 (2016-06-21)
# January 31, 2017. Mallory B. Lai.
# Reviewed by: TODO (Mallory B. Lai) : Find reviewer to proofread
# Creating transcriptomic network for droughted Brassica data using 
# GRENITS package. 
...
resultsFolder <- paste(getwd(), "/DEexpGRENITS_stud", sep = "")

# Run MCMC function; 2 chains, default parameters
ReplicatesNet_student(resultsFolder, Brassica, numReps = 2)
...
write.csv(inferred.net, file = 
            paste(getwd(), "/DEexpGRENITS_stud/inferred.csv", sep = ""))
...
write.csv((prob.list[above.08, ]), file = 
            paste(getwd(), "/DEexpGRENITS_stud/prob_above08.csv", sep = ""))
