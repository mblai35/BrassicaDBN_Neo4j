...
dir.create(paste(getwd(), "/simoneBICclGene", sep = ""))
setwd(paste(getwd(), "/simoneBICclGene", sep = ""))
...
PhenoNet <- getNetwork(DBNsimoneBICcl, "AIC")
...
PhenoNet <- getNetwork(DBNsimoneBICcl)
...
write.csv(DBNsimoneBICcl$clusters, file = 
            paste(getwd(), "/clusters.csv", 
                  sep = ""))

# Plot DBNsimoneBICcl.
pdf("DBNsimoneBICclplots.pdf")
plot(DBNsimoneBICcl)
dev.off()
